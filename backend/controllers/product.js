...
exports.getProductForManager = (req, res) => {
    Product.findOne({ _id: req.product._id, storeId: req.store._id })
        ...
        .then((product) => {
            ...
            return res.json({
                success: 'Truy xuất sản phẩm thành công',
                product,
            });
        })
        .catch((error) => {
...
exports.activeAllProduct = (req, res) => {
    ...
    Product.updateMany(
        ...
        .then(() => {
            return res.json({
                success: 'Mở/khóa cửa hàng & sản phẩm thành công',
                store: req.store,
            });
        })
        .catch((error) => {
...
exports.activeProduct = (req, res) => {
    ...
    Product.findOneAndUpdate(
        ...
        .then((product) => {
            ...
            return res.json({
                success: 'Mở/Khóa trạng thái sản phẩm thành công',
                product,
            });
        })
        .catch((error) => {
...
exports.sellingProduct = (req, res) => {
    ...
    Product.findOneAndUpdate(
        ...
        .then((product) => {
            ...
            return res.json({
                success: 'Cập nhật trạng thái sản phẩm thành công',
                product,
            });
        })
        .catch((error) => {
...
exports.addToListImages = (req, res) => {
    ...
    Product.findOneAndUpdate(
        ...
        .then((product) => {
            ...
            return res.json({
                success: 'Thêm vào danh sách hình ảnh thành công',
                product,
            });
        })
        .catch((error) => {
...
exports.updateListImages = (req, res) => {
    ...
    if (index == -1 || !image)
        return res.status(400).json({
            error: 'Cập nhật danh sách ảnh thất bại',
        });
    ...
    Product.findOneAndUpdate(
        ...
        .then((product) => {
            ...
            return res.json({
                success: 'Cập nhật danh sách hình ảnh thành công',
                product,
            });
        })
        .catch((error) => {
...
exports.removefromListImages = (req, res) => {
    ...
    if (index == -1) {
        return res.status(400).json({
            error: 'Xóa từ danh sách hình ảnh thất bại',
        });
    }
    ...
    if (listImages.length <= 1) {
        return res.status(400).json({
            error: 'listImages phải khác rỗng',
        });
    }
    ...
    Product.findOneAndUpdate(
        ...
        .then((product) => {
            ...
            return res.json({
                success: 'Xóa từ danh sách hình ảnh thành công',
                product,
            });
        })
        .catch((error) => {
