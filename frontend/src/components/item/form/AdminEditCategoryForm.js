        ...
        <div className="p-1 position-relative">
            ...
            >
                <div className="col-12 bg-primary p-3">
                    <h1 className="text-white fs-5 m-0">Sửa loại sản phẩm</h1>
                </div>
                ...
                <div className="col-12 px-4 mt-2">
                    <Input
                        ...
                        feedback="Vui lòng cung cấp tên loại sản phẩm hợp lệ."
                        validator="anything"
                        onChange={(value) =>
                ...
                <div className="col-12 px-4 mt-2">
                    <InputFile
                        ...
                        feedback="Vui lòng cung cấp hình đại diện hợp lệ."
