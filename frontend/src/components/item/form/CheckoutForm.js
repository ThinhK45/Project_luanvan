    ...
    const init = async () => {
        try {
            ...
            setOrder({
                ...
                amountToSG: amountFromUser1 + amountFromUser2 - amountToStore,
            });
        } catch (e) {
        ...
        <div className="position-relative">
            ...
            >
                <div className="col-12 bg-primary p-3">
                    <Logo />
                    <p className="text-white fw-light">Thanh toán</p>
                </div>
                        ...
                        <div className="col-12 mt-2 d-flex justify-content-between align-items-end">
                            <div className="flex-grow-1">
                                <Input
                                    ...
                                    feedback="Vui lòng cung cấp một số điện thoại hợp lệ."
                                    validator="phone"
                                    onChange={(value) =>
                                        handleChange(
                                            'phone',
                        ...
                        <div className="col-12 mt-2 d-flex justify-content-between align-items-end">
                            <div className="flex-grow-1">
                                ...
                                {addresses && addresses.length <= 0 && (
                                    ...
                                    >
                                        <Error msg="Không có địa chỉ để lựa chọn, vui lòng thêm địa chỉ của bạn trước!" />
                                    </small>
                                )}
                            </div>
                ...
                <div className="col-xl-4 col-md-6">
                    <div className="my-2 p-2 border border-primary rounded">
                        ...
                        <dl className="row">
                            <dt className="col-sm-3 col-6">Tổng giá sản phẩm</dt>
                            ...
                            <dt className="col-sm-3 col-6">Tổng tất cả</dt>
                            <dd className="col-sm-9 col-6">
                                <h4 className="text-primary fs-5">
