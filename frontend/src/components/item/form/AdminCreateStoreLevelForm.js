            ...
            <form className="row mb-2" onSubmit={handleSubmit}>
                <div className="col-12">
                    <Input
                        ...
                        feedback="Vui lòng cung cấp tên cấp bậc hợp lệ."
                        validator="name"
                        onChange={(value) =>
                ...
                <div className="col-12">
                    <Input
                        ...
                        feedback="Vui lòng cung cấp điểm hợp lệ (>=0)."
                ...
                <div className="col-12">
                    <Input
                        ...
                        feedback="Vui lòng cung cấp giá trị đặc quyền hợp lệ (0% - 100%)."
                        validator="zeroTo100"
                        onChange={(value) =>
                ...
                <div className="col-12">
                    <Input
                        ...
                        feedback="Vui lòng cung cấp giá trị màu hợp lệ."
                        validator="anything"
                        onChange={(value) =>
